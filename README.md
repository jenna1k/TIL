...
npm install
```
* [Should the package-lock.json file be added to .gitignore?](https://stackoverflow.com/a/48524475)
...
* [Not enough space in /var/cache/apt/archives/](https://superuser.com/questions/1372829/not-enough-space-in-var-cache-apt-archives)
```
su
